...
<body>
    ...
    <div class="container">
        ...
        <div class="intro">
            ...
            <br>
            <p>I am currently employed at Menards but currently seeking employment to utilized my skill as a programmer ideally as a game programmer.
            Back in 2019, I graduated from Chippewa Valley Technical College (CVTC) earning an associate degree in IT - Network Specialist.</p>
